...
namespace BLL.Transactions_BLLs
{
    ...
    {
        Base_BLL<HorarioPeliculas> Base_BLL = new Base_BLL<HorarioPeliculas>();
        ...
        public int AgregarEntidad(HorarioPeliculas horarioPelicula)
        {
            ...
            try
            {
                ...
                {
                    cantDispoAsiAfectadas += Base_Mapper.Agregar(new DisponibilidadAsientos { IDHorarioPelicula = horarioPelicula.ID, IDAsiento = (int)asiento["IDAsiento"], Estado = true }, "AgregarDisponibilidadAsientos");
                }
